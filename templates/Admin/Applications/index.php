	...
	<div class="card-body">
		<div class="card-title mb-2">SEARCH</div>
			...
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Applications','action' => 'index']]); ?>
				<fieldset>
					<div class="mb-1"><?php echo $this->Form->control('staff_no', ['options' => $staffs, 'empty' => 'Select User', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('department_name', ['options' => $departments, 'label' => 'Department', 'class'=>'form-select','empty'=>'Select Department', 'required' => false]); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('application_start_date', ['label' => 'Start Date', 'type' => 'date']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('application_end_date', ['label' => 'End Date', 'type' => 'date']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('application_approval_status', ['options' => $applications, 'empty' => 'Select a faculty/college', 'label' => 'Status', 'class' => 'form-select']); ?></div>
				</fieldset>
