								...
								<?php foreach ($users as $user) : ?>
									<tr>
										...
										<td><?php if ($user->avatar != NULL) {
												echo $this->Html->image('../files/Users/avatar/' . $user->slug . '/' . $user->avatar, ['class' => 'd-block rounded-circle shadow', 'style' => 'width:40px; height:40px; object-fit:cover;']);
											} else
												echo $this->Html->image('blank_profile.png', ['class' => 'd-block rounded-circle shadow', 'class' => 'd-block rounded-circle shadow', 'style' => 'width:40px; height:40px; object-fit:cover;']);
											?>
										</td>
