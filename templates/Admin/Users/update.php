			...
			<div class="row p-3">
				<div class="col-md-2">
					<?php if ($user->avatar != NULL) {
						echo $this->Html->image('../files/Users/avatar/' . $user->slug . '/' . $user->avatar, ['class' => 'd-block rounded shadow', 'style' => 'width:100px; height:100px; object-fit:cover;']);
					} else
						echo $this->Html->image('avatar_default.png', ['alt' => 'avatar', 'class' => 'd-block rounded shadow', 'style' => 'width:100px; height:100px; object-fit:cover;']);
					?>
				</div>
