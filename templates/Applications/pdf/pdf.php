        ...
        <div class="justify">
            ...
            we hereby confirm that this leave application
                                <?php if ($applications->status == 1) {
                                    echo '<b class="text-danger">is in process</b>';
                                } 
            ...
            <br><br>
            <ol type="a">
                <li>&nbsp;&nbsp;&nbsp;&nbsp;Leave Application- <b>
    <a href="http://localhost/leaveapplicationsystem/webroot/files/Applications/image/<?= h($applications->image) ?>"
       target="_blank">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="5%" class="right">
                        <img src="http://localhost/leaveapplicationsystem/qr/qrcode.php?s=qrh&d=<?php echo $this->request->getUri(); ?>" class="qr">
                    </td>
                </tr>
            </table>
        </div>
