...
<div class="mx-auto my-auto p-2 col-md-7 ">
	<div class="card bg-body-tertiary border p-4 rounded shadow">
		<div class="card-body">
			<div class="my-4 text-center">
				<h2 class="my-0 page_title">LOGIN</h2>
			</div>
			<div class="tricolor_line mb-3"></div>
			<?= $this->Form->create() ?>
			<div class="row">
				<div class="col-md-12">
					<?= $this->Form->control('email', ['required' => true, 'class' => 'form-control border-1', 'autocomplete' => 'off']) ?>
				</div>
				<div class="col-md-12">
					<?= $this->Form->control('password', ['required' => true, 'class' => 'form-control border-1']) ?>
				</div>
			</div>
			<div class="text-end">
