...
class ApplicationsController extends AppController
{
	...
	public function pdfList()
	{
        ...
        $this->paginate = [
            'contain' => ['Users', 'Departments', 'Types'],
			'maxLimit' => 10,
        ];
    ...
    public function index()
    {
        ...
        $this->set(compact('applications', 'users', 'departments', 'types', 'monthArray', 'countArray'));
    }
    ...
    public function view($id = null)
    {
        ...
        $application = $this->Applications->get($id, contain: ['Users', 'Departments', 'Types']);
    ...
    {
        $this->viewBuilder()->enableAutoLayout(false);
        $applications = $this->Applications->get($id, ['contain' => ['Types', 'Departments', 'Users']]);
        $this->set(compact('applications'));
        $this->ViewBuilder()->setClassName('CakePdf.Pdf');
        $this->ViewBuilder()->setOption(
            'pdfConfig',
    ...
    public function add()
    {
        ...
        $departments = $this->Applications->Departments->find('list', ['limit' => 200])->all();
        $types = $this->Applications->Types->find('list', ['limit' => 200])->all();
        $this->set(compact('application', 'users', 'departments', 'types'));
    }
    ...
    public function edit($id = null)
    {
		...
		$users = $this->Applications->Userss->find('list', limit: 200)->all();
		$departments = $this->Applications->Departments->find('list', limit: 200)->all();
		$types = $this->Applications->Types->find('list', limit: 200)->all();
        $this->set(compact('application', 'users', 'departments', 'types'));
    }
